...
class AddressRangesTest(unittest.TestCase):
    def _test_range(
        ...
        res = merge_address_ranges(
            address_ranges, allow_holes=allow_holes, max_read_size=max_read_size
        )
    ...
    def test_overlapping(self) -> None:
        self._test_range(
            [(0, 10)], [(0, 1), (0, 5), (5, 9), (10, 10)], allow_holes=True
        )
        self._test_range([(7, 15)], [(10, 15), (7, 12)], allow_holes=True)

    def test_max_read(self) -> None:
        self._test_range(
            [(0, 1), (15, 16)], [(0, 1), (15, 16)], allow_holes=True, max_read_size=10
        )
        self._test_range(
            [(0, 9), (15, 16)],
            [(0, 1), (8, 9), (15, 16)],
        ...
        self._test_range(
            [(0, 16)], [(0, 1), (15, 16)], allow_holes=True, max_read_size=100
        )
